...
//		prefsEditor = prefs.edit();
		prefs = mContext.getSharedPreferences(PrintAtMITActivity.PREFS_NAME, PrintAtMITActivity.MODE_PRIVATE);
		prefsEditor = prefs.edit();
		
		MITClient.user = prefs.getString(TOUCHSTONE_USERNAME, null);
		MITClient.password = prefs.getString(TOUCHSTONE_PASSWORD, null);
...
//		}
	...
	public void saveLogin() {
		// rememberLogin = prefs.getBoolean("PREF_TOUCHSTONE_REMEMBER_LOGIN", false);
		// if (rememberLogin) {
			prefsEditor.putString(TOUCHSTONE_USERNAME, MITClient.getUser());
			prefsEditor.putString(TOUCHSTONE_PASSWORD, MITClient.getPassword());
			prefsEditor.commit();
		// }
	}
}
